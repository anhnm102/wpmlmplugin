...
Automatic installation is the easiest option where you can directly search for the plugin and You can view the details about WP MLM Plugin such as the point release, rating and description.
. 
...
- Activate WP MLM.
- A new menu item would be created in the admin menu called WP MLM.
